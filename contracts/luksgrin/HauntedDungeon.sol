...
//     // modifier happens after function code
//     modifier alive() {
//         _;
...
//                 (int256(random()) % 10) +
//                     baseStats[currentFloor[msg.sender] - 1], //1, 3, 5, 7, 50
//                 2 *
//                     (int256(random()) % 7) +
...
//             restore(); // lives = 3, attack / 2, dfense /2, store access + (1+current floor)
