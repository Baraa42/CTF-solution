...
//         // for marketing
//         _mint(address(this), 1_000_000); // contract has million tokens
//     }
...
//         StorageSlot.getBytes32Slot(bytes32(slot)).value = value; // solve storage slot
//         return solver == owner();
//     }
...
// // need to make him call my delegate call
// // need external_repair_requested to be true
// // need onlybroker and only private modifiers
// // broken need to success in function brake
// // onlyPrivate means only this contract can call
// //
