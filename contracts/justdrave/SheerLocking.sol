...
//     // need to go through the setup
//     modifier lockone() {
//         require(msg.sender == DEPLOYER, "lockone");
//         _;
//     }
//     // shouldnt be hard
//     modifier lockTwo() {
//         require(msg.sender != tx.origin, "locktwo");
//         _;
//     }
//     // lot of locks around some arguments
//     modifier lockThree1(bytes8 _keyThree) {
//         require(
//             uint32(uint64(_keyThree)) == uint16(uint64(_keyThree)),
//             "lockThree11"
//         );
//         require(uint32(uint64(_keyThree)) != uint64(_keyThree), "lockThree12");
//         _;
//     }

//     modifier lockThree2(bytes8 _keyThree) {
//         require(
//             uint32(uint64(_keyThree)) == uint128(uint64(_keyThree)),
//             "lockThree21"
//         );
//         require(uint32(uint64(_keyThree)) != uint64(_keyThree), "lockThree22");
//         _;
//     }

//     modifier lockThree4(bytes8 _keyThree) {
//         require(
//             uint32(uint64(_keyThree)) == uint8(uint64(_keyThree)),
//             "lockThree41"
//         );
//         require(uint8(uint64(_keyThree)) != uint64(_keyThree), "lockThree42");
//         _;
//     }
...
//             "lockThree31"
//         );
//         require(uint32(uint64(_keyThree)) != uint64(_keyThree), "lockThree32");
//         _;
//     }

//     modifier lockThree7(bytes8 _keyThree) {
//         require(
//             uint8(uint64(_keyThree)) == uint16(uint64(_keyThree)),
//             "lockThree71"
//         );
//         require(uint8(uint64(_keyThree)) != uint64(_keyThree), "lockThree72");
//         _;
//     }
//     // tx origin locks
//     modifier lockOne1() {
//         require(
//             !_blackList1[tx.origin] && !_blackList1[msg.sender],
//             "lockOne1"
//         );
...
//     modifier lockOne2() {
//         require(
//             !_blackList2[tx.origin] && !_blackList2[msg.sender],
//             "lockOne2"
//         );
...
//     modifier lockOne3() {
//         require(
//             !_blackList3[tx.origin] && !_blackList3[msg.sender],
//             "lockOne3"
//         );
...
//     modifier lockOne4() {
//         require(
//             !_blackList4[tx.origin] && !_blackList4[msg.sender],
//             "lockOne4"
//         );
...
//     modifier lockOne5() {
//         require(
//             !_blackList5[tx.origin] && !_blackList5[msg.sender],
//             "lockOne5"
//         );
...
//     modifier lockOne6() {
//         require(
//             !_blackList6[tx.origin] && !_blackList6[msg.sender],
//             "lockOne6"
//         );
...
//     modifier lockOne7() {
//         require(
//             !_blackList7[tx.origin] && !_blackList7[msg.sender],
//             "lockOne7"
//         );
...
//         // tx.origin and msg.sender not blacklisted,
//         // msg.sender != tx.origin
//         // keyThree pass lockThree1
//         // lockFive call from a non contract
