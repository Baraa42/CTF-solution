...
//             "You can't change the beneficiary anymore"
//         );
...
//     // no modifier on it u can restart again
...
//         require(
//             checkAmount(msg.sender, msg.value),
//             "You can't contribute less than minimum"
//         );
...
//     // i can make someone contribue less than the min
...
//     function checkAmount(address user, uint256 amount)
//         internal
//         view
//         returns (bool v)
//     {
...
//         require(fundraisingOpened, "The fundraising is closed");
//         require(
//             collaborations[msg.sender].amount >= _minCollab,
//             "Your collaboration is unable to be refunded"
//         );
...
//         require(
//             block.timestamp > fundingEndDate ||
//                 address(this).balance >= _targetFunds,
//             "The fundraising hasn't finished yet"
//         );
...
//         require(
//             collaborations[user].amount < _minCollab &&
//                 collaborations[user].amount > 0,
//             "Not an invalid amount"
//         );
...
//         collaborations[msg.sender].amount += incentive; // flag here i can empy the contract like that
//         collaborations[msg.sender].timestamp = block.timestamp;
